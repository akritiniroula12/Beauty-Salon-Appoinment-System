...
function StaffSidebar() {
    ...
    const userData = user || JSON.parse(localStorage.getItem('user')) || { name: 'Staff' };
    ...
    const menuItems = [
        ...
        { path: '/staff/availability', icon: Clock, label: 'Availability' },
                ...
                <div className="flex flex-col h-full">
                    ...
                    <div className="pt-12 pb-8 flex flex-col items-center justify-center">
                        ...
                        <div className="flex items-center mt-1">
                            ...
                            <p className="text-[10px] font-bold tracking-[0.4em] text-[#FF2D7D] uppercase">Staff Portal</p>
                        </div>
                    </div>
                    ...
                    <div className="p-6 border-t border-gray-50 bg-gray-50/30">
                        ...
                        <div className="flex items-center mb-6 px-2">
                            ...
                            <div className="ml-3">
                                ...
                                <p className="text-[10px] text-gray-400 font-semibold uppercase tracking-tight">Staff Member</p>
                            </div>
                        </div>
